...
// void layernorm(QT_S_I8_PC *Y, QT_S_I8_PC *A, T_FP *scale = nullptr, T_FP *bias = nullptr, float eps=1e-5); 
// void layernorm(QT_S_I8_PG *Y, QT_S_I8_PG *A, T_FP *scale = nullptr, T_FP *bias = nullptr, float eps=1e-5); 
